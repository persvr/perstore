...
exports.testBehavior = function() {
    ...
    assert.ok(parseQuery("") instanceof resourceQuery.Query, "should inherit from Query");
    assert.ok(parseQuery("a=b") instanceof resourceQuery.Query, "should inherit from Query");
