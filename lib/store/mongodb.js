...
var mongo = require('mongodb/db'),
	...
	sys = require('sys'),
	convertNodeAsyncFunction = require("commonjs-utils/promise").convertNodeAsyncFunction,
...
exports.MongoDB = function(options){
	...
	return {
		...
		get: function(id){
			...
			return callAsync(collection.findOne, [{_id:to_id(id)}]).then(function(data){
				data.id = data._id;
				delete data._id;
				return data;
			});
		...
		put: function(object, directives){
			...
			if (!id) id = object._id;
			if (!id) {
				id = object._id = BSON.ObjectID.createPk().toJSON();
			}
