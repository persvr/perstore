...
var schemas = {}, models = {};
exports.Model = function(name, store, schema, options) {
	options = options || {};
	...
	// not nested as default
	if (typeof options.nested === "undefined") options.nested = true;
	if (!options.nested) registerRootStore(name, store, schema);
	return schema;
};
