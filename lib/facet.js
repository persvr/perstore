 ...
 */
require = require("compatibility/require-url").getRequire(require);

var NotFoundError = require("./errors").NotFoundError,
	AccessError = require("./errors").AccessError,
	MethodNotAllowedError = require("./errors").MethodNotAllowedError,
	defineProperties = require("http://github.com/kriszyp/commonjs-utils/raw/master/lib/es5-helper").defineProperties,
	LazyArray = require("http://github.com/kriszyp/commonjs-utils/raw/master/lib/lazy-array").LazyArray,
	when = require("system://promise").when;
			...
			return when(instance, function(instance){
				if(!instance){
					...
					return when(instance.save(directives), function(newInstance){
						if(directives.id && ((newInstance.getId ? newInstance.getId() : newInstance.id) != directives.id)){ 
