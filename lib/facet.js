...
function FacetedStore(store, facetSchema, permissive){
	...
	constructor.add = function(props, directives){
		return constructor.construct(props).save();
	};
...
/*			// TODO: allow for multiple same-name relations
	...
	if(!facetSchema.getId){
		if(idTemplate){
			facetSchema.getId = function(object){
					...
					defineProperties(instancePrototype,{
						save: {
							value: function(directives){
								...
								if(isNew && (typeof facetSchema.add === "function" || (permissive && typeof sourceClass.add === "function"))){
									partial = undefined;
									if(typeof facetSchema.add === "function"){
									...
									if(typeof facetSchema.put === "function"){
										...
										if(permissive && typeof sourceClass.put === "function"){
