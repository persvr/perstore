...
exports.Restrictive = function(appliesTo, schema){
	...
	schema.__noSuchMethod__ || (Object.defineProperty(schema,"__noSuchMethod__", {enumerable: false, value: function(name, args, onlyIfAvailable){
	...
	if(appliesToPrototype){
		...
		schemaPrototype.__noSuchMethod= function(name, source, args, onlyIfAvailable){
...
exports.Permissive = function(appliesTo, schema){
	...
	if(appliesToPrototype){
		var schemaPrototype = schema.prototype = schema.prototype || {};
		Object.defineProperty(schemaPrototype,"__noSuchMethod__", {enumerable: false, value: function(name, source, args, onlyIfAvailable){
			if(appliesToPrototype[name]){
				return appliesToPrototype[name].apply(source, args);
			}
			if(appliesToPrototype.__noSuchMethod__){
