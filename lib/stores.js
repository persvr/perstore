...
exports.DefaultStore = function(name){
	return JSFile((require("commonjs-utils/settings").dataFolder || "data") + "/" + name);
};
...
exports.AutoTransaction = function(store, database){
	...
	for(var i in store){
		if(typeof store[i] === "function" && i != "transaction"){
...
var JSFile = require("perstore/store/js-file").JSFile;
